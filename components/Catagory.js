...
function Catagory() {
  return (
    <div className="container my-8 h-[600px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 lg:auto-rows-[minmax(40px,_auto)] gap-8 lg:gap-4">
      <div className=" bg-Green-light flex catagoryCard lg:row-span-5 lg:col-span-2">
        <Image src={Cactus} alt="Cactus" />
